  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          <div className="flex flex-col gap-2 lg:grid lg:grid-cols-form lg:gap-3">
            <label
              htmlFor="firstName"
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="firstName" placeholder="firstName" />
              </Input.Root>
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control placeholder="LastName" />
                </Input.Root>
              </div>
            </div>
          </div>

          <div className="flex flex-col gap-2 pt-5 lg:grid lg:grid-cols-form lg:gap-3">
            <label
              htmlFor="email"
              className="text-sm font-medium text-zinc-700 dark:text-zinc-300"
            >
            ...
            <Input.Root>
              ...
              <Input.Control id="email" type="email" placeholder="Email" />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              <Input.Control id="role" placeholder="Software developer" />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                id="bio"
                defaultValue="I'm a Product Designer based in Melbourne, Australia. I specialized in UX/UI design, brand strategy, and Weblog development."
              />
            </div>
          </div>
