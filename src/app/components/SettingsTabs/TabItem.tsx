...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    ...
    >
      <span className="ground-focus-visible:ring-2 group-focus-visible-ring-violet-400 whitespace-nowrap group-focus-visible:ring-offset-4">
        {title}
      </span>

      {isSelected && (
        <motion.div
          layoutId="activeMotion"
